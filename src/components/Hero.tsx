          ...
          <div className="space-y-8 relative z-10">
            <div className="space-y-4">
              <div className="flex items-center space-x-2 mb-4">
                <Sparkles className="text-cyan-500 animate-spin-slow" size={24} />
                <span className="text-cyan-600 font-semibold text-lg">Welcome to the Future of Healthcare</span>
              </div>
              <h1 className="text-5xl lg:text-7xl font-bold leading-tight animate-fadeInUp">
                Your Health is Our
                <span className="bg-gradient-to-r from-cyan-600 via-teal-500 to-orange-500 bg-clip-text text-transparent block animate-pulse">Priority</span>
              </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <button
                ...
                className="group relative bg-gradient-to-r from-cyan-600 via-teal-500 to-orange-500 text-white px-8 py-4 rounded-full hover:shadow-2xl hover:shadow-cyan-500/25 transition-all duration-500 font-medium flex items-center justify-center space-x-2 transform hover:scale-110 overflow-hidden animate-fadeInUp animation-delay-600"
              >
              ...
              <button
                ...
                className="relative border-2 border-cyan-500 text-cyan-600 px-8 py-4 rounded-full hover:bg-gradient-to-r hover:from-cyan-600 hover:via-teal-500 hover:to-orange-500 hover:text-white hover:border-transparent transition-all duration-500 font-medium transform hover:scale-110 animate-fadeInUp animation-delay-800 overflow-hidden group"
              >
                <span className="absolute inset-0 bg-gradient-to-r from-cyan-600 via-teal-500 to-orange-500 opacity-0 group-hover:opacity-100 transition-opacity duration-500 rounded-full"></span>
            ...
            <div className="grid grid-cols-3 gap-8 pt-8 animate-fadeInUp animation-delay-1000">
              <div className="text-center">
                <div className="flex items-center justify-center w-16 h-16 bg-gradient-to-br from-cyan-100 to-teal-100 rounded-2xl mx-auto mb-3 transform hover:scale-110 transition-all duration-300 hover:shadow-lg group">
                  <Users className="text-cyan-600 group-hover:animate-bounce" size={28} />
                </div>
                <div className="text-3xl font-bold bg-gradient-to-r from-cyan-600 to-teal-500 bg-clip-text text-transparent">50+</div>
              ...
              <div className="text-center">
                <div className="flex items-center justify-center w-16 h-16 bg-gradient-to-br from-orange-100 to-red-100 rounded-2xl mx-auto mb-3 transform hover:scale-110 transition-all duration-300 hover:shadow-lg group">
                  <Clock className="text-orange-600 group-hover:animate-bounce" size={28} />
                </div>
                <div className="text-3xl font-bold bg-gradient-to-r from-orange-600 to-red-500 bg-clip-text text-transparent">24/7</div>
          ...
          <div className="relative animate-fadeInRight">
            <div className="relative z-10 group">
              <img
                ...
                className="rounded-3xl shadow-2xl w-full h-[600px] object-cover transform group-hover:scale-105 transition-all duration-700 hover:shadow-cyan-500/25"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-cyan-900/20 to-transparent rounded-3xl"></div>
            </div>
            {/* Background decoration */}
            <div className="absolute top-8 left-8 w-full h-full bg-gradient-to-br from-cyan-200 to-teal-200 rounded-3xl -z-10 transform rotate-3 animate-float"></div>
            <div className="absolute top-4 left-4 w-full h-full bg-gradient-to-br from-teal-200 to-orange-200 rounded-3xl -z-20 transform rotate-6 animate-float animation-delay-1000"></div>
          </div>
        </div>
      </div>
    </section>
