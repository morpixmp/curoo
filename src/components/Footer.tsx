  ...
  return (
    <footer className="relative bg-gradient-to-br from-gray-900 via-purple-900 to-indigo-900 text-white overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-orange-500 rounded-full mix-blend-multiply filter blur-3xl opacity-10 animate-pulse animation-delay-2000"></div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid lg:grid-cols-4 md:grid-cols-2 gap-8 relative z-10">
          ...
          <div className="space-y-6">
            <div className="flex items-center space-x-3 group">
              <div className="relative w-12 h-12 bg-gradient-to-br from-cyan-600 via-teal-500 to-orange-500 rounded-full flex items-center justify-center transform group-hover:scale-110 transition-all duration-300">
                <Heart className="text-white animate-pulse" size={20} />
                <div className="absolute inset-0 bg-gradient-to-br from-cyan-600 via-teal-500 to-orange-500 rounded-full animate-ping opacity-20"></div>
              </div>
              <div>
                <h3 className="text-2xl font-bold bg-gradient-to-r from-cyan-400 via-teal-300 to-orange-300 bg-clip-text text-transparent">Healing Hands</h3>
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-lg font-bold bg-gradient-to-r from-cyan-400 to-orange-300 bg-clip-text text-transparent mb-6 flex items-center space-x-2">
            ...
            <ul className="space-y-3">
              <li>
                <button
                  ...
                  className="text-gray-300 hover:text-white transition-all duration-300 transform hover:translate-x-2 hover:text-cyan-300"
                >
                  Home
                </button>
              </li>
          ...
          {/* Services */}
          <div>
            <h4 className="text-lg font-bold bg-gradient-to-r from-teal-400 to-green-300 bg-clip-text text-transparent mb-6 flex items-center space-x-2">
              <Sparkles className="text-teal-400 animate-pulse" size={16} />
              <span>Our Services</span>
            </h4>
            <ul className="space-y-3 text-gray-300">
              <li>
                <a href="#" className="hover:text-white transition-all duration-300 transform hover:translate-x-2 hover:text-teal-300">
                  Cardiology
                </a>
              </li>
              <li>
          ...
          {/* Contact Info */}
          <div>
            <h4 className="text-lg font-bold bg-gradient-to-r from-blue-400 to-cyan-300 bg-clip-text text-transparent mb-6 flex items-center space-x-2">
              <Sparkles className="text-blue-400 animate-pulse" size={16} />
              <span>Contact Info</span>
            </h4>
            <div className="space-y-4">
              <div className="flex items-start space-x-3 group">
                <MapPin className="text-cyan-400 mt-1 group-hover:animate-bounce" size={18} />
              ...
              <div className="flex items-center space-x-3 group">
                <Phone className="text-teal-400 group-hover:animate-bounce" size={18} />
                <div className="text-gray-200">
                  <p>(555) 123-4567</p>
                </div>
              </div>
            ...
            {/* Emergency Notice */}
            <div className="mt-6 p-4 bg-gradient-to-r from-red-900/40 to-orange-900/40 border-2 border-red-700/50 rounded-2xl backdrop-blur-sm transform hover:scale-105 transition-all duration-300">
              <p className="text-orange-300 text-sm font-bold flex items-center space-x-2">
        ...
        <div className="border-t border-gray-700/50 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center relative z-10">
          ...
          <div className="flex space-x-6 mt-4 md:mt-0">
            <a href="#" className="text-gray-400 hover:text-white text-sm transition-all duration-300 transform hover:translate-y-1 hover:text-cyan-300">
              Privacy Policy
            </a>
            <a href="#" className="text-gray-400 hover:text-white text-sm transition-all duration-300 transform hover:translate-y-1 hover:text-cyan-300">
              Terms of Service
