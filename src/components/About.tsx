  ...
  return (
    <section id="about" className="relative py-20 bg-gradient-to-br from-white via-purple-50/30 to-pink-50/30 overflow-hidden">
      ...
      <div className="absolute inset-0">
        <div className="absolute top-0 left-1/4 w-96 h-96 bg-cyan-200 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-pulse"></div>
        <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-orange-200 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-pulse animation-delay-2000"></div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16 animate-fadeInUp">
          <div className="flex items-center justify-center space-x-2 mb-4">
            ...
            <span className="text-cyan-600 font-semibold">About Our Medical Center</span>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center mb-20 animate-fadeInUp animation-delay-600">
          ...
          <div className="space-y-6">
            <h3 className="text-3xl font-bold bg-gradient-to-r from-cyan-600 to-orange-500 bg-clip-text text-transparent">Our Story</h3>
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              <div className="bg-gradient-to-br from-cyan-50 to-teal-50 p-6 rounded-2xl flex-1 transform hover:scale-105 transition-all duration-300 hover:shadow-lg group">
                <div className="text-4xl font-bold bg-gradient-to-r from-cyan-600 to-teal-500 bg-clip-text text-transparent mb-2 group-hover:animate-pulse">50,000+</div>
                <div className="text-gray-700">Patients Served</div>
              </div>
              <div className="bg-gradient-to-br from-orange-50 to-red-50 p-6 rounded-2xl flex-1 transform hover:scale-105 transition-all duration-300 hover:shadow-lg group">
                <div className="text-4xl font-bold bg-gradient-to-r from-orange-600 to-red-500 bg-clip-text text-transparent mb-2 group-hover:animate-pulse">15</div>
          ...
          <div className="relative group">
            <img
              ...
              className="rounded-3xl shadow-2xl w-full h-[500px] object-cover transform group-hover:scale-105 transition-all duration-700 hover:shadow-cyan-500/25"
            />
        ...
        <div className="text-center mb-16">
          <div className="flex items-center justify-center space-x-2 mb-4">
            ...
            <h3 className="text-4xl font-bold bg-gradient-to-r from-cyan-600 to-orange-500 bg-clip-text text-transparent">Our Mission</h3>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 animate-fadeInUp animation-delay-1000">
          {values.map((value, index) => {
            ...
            return (
              <div
                key={index}
                className="text-center p-8 rounded-2xl bg-white/50 backdrop-blur-sm hover:bg-white/80 hover:shadow-2xl hover:shadow-cyan-500/10 transition-all duration-500 transform hover:scale-105 hover:-translate-y-2 group border border-cyan-100/50"
              >
                <div className="w-20 h-20 bg-gradient-to-br from-cyan-100 via-teal-100 to-orange-100 rounded-2xl flex items-center justify-center mx-auto mb-6 transform group-hover:scale-110 group-hover:rotate-6 transition-all duration-300">
                  <IconComponent className="text-cyan-600 group-hover:animate-bounce" size={32} />
                </div>
                <h4 className="text-xl font-bold bg-gradient-to-r from-cyan-600 to-orange-500 bg-clip-text text-transparent mb-4">{value.title}</h4>
